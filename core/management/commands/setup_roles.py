...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        delete_category = Permission.objects.get(codename="delete_category", content_type=category_ct)
        ...
        self.stdout.write(self.style.SUCCESS("Roles created/updated: Admin, Seller, Customer"))
